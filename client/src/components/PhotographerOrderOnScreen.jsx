                    ...
                    {enableShow && <div className="modal">
                        <div className="modal-content">
                            ...
                            <div className="changeStateBtn">
                                {enableUpdate && <button className="btnInOrder" onClick={()=>handleUpdateClick(2)}>Update</button>}
                                {enableCancele && <button className="btnInOrder" onClick={()=>handleUpdateClick(4)}>confirm</button>}
                            </div>
                        </div>
                    </div>}
                </div>
